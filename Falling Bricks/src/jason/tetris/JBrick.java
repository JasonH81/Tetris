...
public class JBrick extends Brick {
	...
	private static final boolean TILES[][][] = {{{true, true, true},{false, false, true}}, {{false, true}, {false, true}, {true, true}}, {{true, false, false},{true, true, true}}, {{true, true}, {true, false}, {true, false}}};
