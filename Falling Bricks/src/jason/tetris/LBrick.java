...
public class LBrick extends Brick {
	...
	private static final boolean TILES[][][] = {{{true, true, true},{true, false, false}}, {{true, true}, {false, true}, {false, true}}, {{false, false, true},{true, true, true}}, {{true, false}, {true, false}, {true, true}}};
